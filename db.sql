...
/* criando uma copia do database para testes */

create database mocksourcecodeplataform;

create table mocksourcecodeplataform.usuarios like sourcecodeplataform.usuarios;
create table mocksourcecodeplataform.projetos like sourcecodeplataform.projetos;
create table mocksourcecodeplataform.usuarios_projetos like sourcecodeplataform.usuarios_projetos;
  
ALTER TABLE mocksourcecodeplataform.usuarios_projetos 
    ADD CONSTRAINT FK_USUARIO_PROJETO FOREIGN KEY (idUsuario) REFERENCES mocksourcecodeplataform.usuarios (id);

ALTER TABLE mocksourcecodeplataform.usuarios_projetos 
    ADD CONSTRAINT FK_PROJETO_USUARIO FOREIGN KEY (idProjeto) REFERENCES mocksourcecodeplataform.projetos (id);  
